...
# How it's organized
## Code
01. Documento Final/          Final thesis document
02. Referencias/              References and source materials
...
- Install Jupyter and Python analysis libraries (pandas, numpy, scipy, etc.)
- Open the notebook: jupyter notebook "04. Codigo Final Tesis/GroupAnalysis_4.ipynb"
- Run all cells to perform the statistical analysis
- The data files referenced (Data_Final.xlsx) are included in the same directory.
